...
4 - Crie outra estrutura de dados com os membros abaixo. Acrescente esta nova
    estrutura a estrutura de dados do exercicio anterior (estrutura dentro de outra
    estrutura) como mais um membro e receba via teclado todos os dados. Declare a
    variavel como local e imprima estes conteudos no video. 
             tel, cpf, rg

5 - Com a estrutura do exercicio 3 acima defina um vetor de estruturas de 3 elementos.         Receba os dados pelo teclado e imprima-os no video. (vetor de estruturas)
*/
